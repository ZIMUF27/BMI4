...
"[project]/src/app/api/bmi/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    ...
    try {
        ...
        const record = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].bMI_Record.create({
            data: {
...
async function GET(req) {
    ...
    try {
        const records = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].bMI_Record.findMany({
            where: {
                user_id: parseInt(session.user.id)
            },
            orderBy: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d389562c._.js.map